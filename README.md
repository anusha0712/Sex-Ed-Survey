...
1. Jupyter Notebook with the code and markdown exploring the data analysis
2. The images with all the figures and graphs created using the Survey Data. 
3. A Poster with the entire research summarised, along with figures and interpretations
